...
from src.weather_loader import merge_with_prices
from src.signals import add_price_signals, print_signal_summary
from src.battery_logic import BatterySimulator, BatteryConfig
...
def cmd_pipeline(args):
    ...
    results[["datetime", "price", "hour", "action", "soc", "energy_delta", "revenue"]].to_csv(
        output_dir / "battery_simulation.csv", index=False
    )
